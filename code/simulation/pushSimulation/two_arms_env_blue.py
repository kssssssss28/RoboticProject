...
class GARBAGE():
    ...
    def generateGarbage(self):
        ...
        rdPosition = [self.gar_x[self.cur],-4.1,.4] 
...
class GarbageSortingEnvOnlyRedV2(gym.Env):
    ...
    def load_models(self):
        ...
        self.robot_arm_ids = p.loadURDF('../simulation/urdf/ur5_robotiq_85.urdf', [0 - self.move_right,1,0.5], p.getQuaternionFromEuler([0, 0, -.6]))        # -1.6 
        self.robot_arm_ids2 = p.loadURDF('../simulation/urdf/ur5_robotiq_85.urdf', [1.3, -2.3,0.47], p.getQuaternionFromEuler([0, 0, 3.6]))        
        # ------------------------- robotic arm ------------------------------
    ...
    def reset(self):
        ...
        self.steps = 0
        self.accumulated_reward = 0
        joint_positions = [ 0.   ,      -1.64401707 ,-0.07291283 , 0.42961074 , 0.19542162 ,-0.7959876 ] # 刚刚好
